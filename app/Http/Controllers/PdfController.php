...
class PdfController extends Controller
{
    public function generatePDF(Request $request, $id)
    {
        ...
        foreach ($data as $user) {
            ...
            if ($surat == 'Surat Keterangan Ijin Keramaian') {
...
Tempat                                : $user->tempat",
            ...
            } elseif ($surat == 'Surat Keterangan Beda Penulisan') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
Selanjutnya menurut keterangan yang bersangkutan, nama tersebut diatas menunjuk pada 1 (satu) orang yang sama. \n               Surat Keterangan ini digunakan untuk persyaratan : 
            ...
            } elseif ($surat == 'Surat Keterangan Yang Bersangkutan') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
                ...
                foreach ($data as $id_kk) {
                    ...
                    // Output PDF
                    $pdf->Output($user->nama_lengkap . '_' . $user->nik . '_Surat_Keterangan_Yang_Bersangkutan.pdf', 'D');
                    exit;
                }
            } elseif ($surat == 'Surat Pengantar Kehilangan') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
3. $user->barang_hilang3", 0, 'L');
                    ...
                    // Output PDF
                    $pdf->Output($user->nama_lengkap . '_' . $user->nik . '_Surat_Pengantar_Kehilangan.pdf', 'D');
                    exit;
                }
...
2. Hubungan dengan yang meninggal : $user->hubunganalm",
            ...
            } elseif ($surat == 'Surat Penutupan Jalan') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
", 0, 'L');
                    ...
                    // Output PDF
                    $pdf->Output($user->nama_lengkap . '_' . $user->nik . '_Surat_Penutupan_Jalan.pdf', 'D');
                    exit;
                }
            } elseif ($surat == 'SKCK OT') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
                ...
                foreach ($data as $id_kk) {
                    ...
                    // Output PDF
                    $pdf->Output($user->nama_lengkap . '_' . $user->nik . '_SuratKeteranganBelumMenikah.pdf', 'D');
                    exit;
                }
            } elseif ($surat == 'Surat Keterangan Pengajuan KIS') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
                ...
                foreach ($data as $id_kk) {
                    ...
                    $pdf->SetFont('Times', '', 12);
                    $pdf->SetXY(20, $pdf->GetY() + 5);
                    $pdf->MultiCell(0, 6, "Nomor : $nomorSurat / $kodeKecamatan / $nomossurattambahan / $tahunSekarang", 0, 'C');
            ...
            } elseif ($surat == 'Surat Keterangan Lahir') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
            ...
            } elseif ($surat == 'Surat Keterangan Domisili Organisasi') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
            ...
            } elseif ($surat == 'SKTM (KIS, SAKIT & PERSALINAN)') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
Berdasar Surat Pengantar RT $user->rt RW $user->rw Kelurahan Tompokersan Tanggal 30 Agustus 2024 Nomor RT$user->rt/RW$user->rw/$tahunSekarang dan menurut keterangan yang bersangkutan, termasuk kurang mampu dalam ekonomi.", 0, 'L');
            ...
            } elseif ($surat == 'SKTM (SEKOLAH & BIDIK MISI)') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
", 0, 'L');
            ...
            } elseif ($surat == 'Surat Keterangan Bepergian') {
                ...
                $pdf->SetFont('Times', '', 12);
                $pdf->SetXY(20, 58);
                $pdf->MultiCell(0, 6, "Nomor: $nomorSurat", 0, 'C');
                ...
                $pdf->Output($user->nama_lengkap . '_' . $user->nik . '_' . $user->nama_surat . '.pdf', 'D');
                exit;
            } elseif ($surat == 'Surat Transaksi Harga Tanah') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
-	Sebelah Barat	:	$user->barat", 0, 'L');
            ...
            } elseif ($surat == 'Surat Keterangan Memiliki Usaha') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
...
", 0, 'L');
            ...
            } elseif ($surat == 'Surat Keterangan Pindah Nikah') {
                $data = MobileMasterMasyarakatModel::where('id_masyarakat', '=', $user->id_masyarakat)
                    ->select('id_kk')
                    ->get();
